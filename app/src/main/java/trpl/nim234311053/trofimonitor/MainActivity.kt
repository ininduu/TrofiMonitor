package trpl.nim234311053.trofimonitor
...
import trpl.nim234311053.trofimonitor.ui.theme.TrofiMonitorTheme
...
fun ClubListScreen(navController: NavController, clubs: List<Club>) {
    val studentName = "Rizqi Agus Sahputra"
    val studentID = "234311053"
...
fun ClubLogo(club: Club) {
    val logoResId = when (club.name) {
        ...
        "Liverpool" -> R.drawable.liverppool
        "Chealsea" -> R.drawable.chealsea
        "Manchester City" -> R.drawable.manchester_city
        "Arsenal" -> R.drawable.arsenal
        "Tottenham Hotspur" -> R.drawable.totenham_hotspur
...
fun createClubList(): List<Club> {
    return listOf(
        ...
        Club("Chealsea", premierLeague = 6, faCup = 8, eflCup = 5, championsLeague = 2, europaLeague = 2),
